...
public class InicioFragment extends Fragment implements Communication, MostrarBadgeCommunication {
    ...
    private void loadData() {
        ...
        lista.add(new SliderItem(R.drawable.promo_alitas, "Las mejores alitas"));
        lista.add(new SliderItem(R.drawable.trio_marino, "El gran trio marino"));
        lista.add(new SliderItem(R.drawable.ceviche, "El mejor ceviche"));
